...
#ifndef LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_USEStdFormatCHECK_H
#define LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_USEStdFormatCHECK_H

#include "../ClangTidyCheck.h"
#include "../utils/IncludeInserter.h"

namespace clang::tidy::modernize {
/// Convert calls to sprintf-like functions to std::format
///
...
#endif // LLVM_CLANG_TOOLS_EXTRA_CLANG_TIDY_USEStdFormatCHECK_H
